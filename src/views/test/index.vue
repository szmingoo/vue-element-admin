<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <el-button type="primary" size="small" plain @click="handleUpdate(row)">编辑</el-button>
    ...
    />
    <!-- 新增-修改 -->
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="29%">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="接口名称" prop="name" placeholder="请输入接口名称" size="small">
          <el-input v-model="temp.name" />
        </el-form-item>
        <el-form-item label="接口地址" prop="url" placeholder="请输入接口地址" size="small">
